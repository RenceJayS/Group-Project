...
public class CheckoutController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image CookiesNCream = new Image(LoginController.blamp.getProductImage());
        img1.setImage(CookiesNCream);

        name2.setText(LoginController.clamp.getProductName());
        price2.setText(Double.toString(LoginController.clamp.getProductPrice()));
        Image Matcha = new Image(LoginController.clamp.getProductImage());
        img2.setImage(Matcha);

        name3.setText(LoginController.wlamp.getProductName());
        price3.setText(Double.toString(LoginController.wlamp.getProductPrice()));
        Image Wintermelon = new Image(LoginController.wlamp.getProductImage());
        img3.setImage(Wintermelon);
