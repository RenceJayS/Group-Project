...
public class LightController implements Initializable {
    ...
    @FXML
    Label name1, name2, name3, name5, name6, price1, price2, price3, price5, price6;

    @FXML
    ImageView img1, img2, img3, img5;

    @FXML
    Button button1, button2, button3, button5, cartbutton;
    ...
    public void buy(ActionEvent event) throws IOException {
        ...
        AlertMaker.showSimpleAlert("HI!", "The item is added");
